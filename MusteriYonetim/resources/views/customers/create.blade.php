                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('customers.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="hizmet_alan_isyeri_unvani" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="hizmet_alan_isyeri_unvani" :value="old('hizmet_alan_isyeri_unvani')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="firma_no" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="firma_no" :value="old('firma_no')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="gorunur_unvani" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="gorunur_unvani" :value="old('gorunur_unvani')" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="faaliyet" name="faaliyet" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="calisan_sayisi" class="block mt-1 w-full text-gray-900 dark:text-white" type="number" name="calisan_sayisi" :value="old('calisan_sayisi')" min="0" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="tehlike_sinifi" name="tehlike_sinifi" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                <option value="">Seçiniz</option>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="firma_sorumlusu" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="firma_sorumlusu" :value="old('firma_sorumlusu')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="telefon_numarasi" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="telefon_numarasi" :value="old('telefon_numarasi')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="il" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="il" :value="old('il')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="mahalle" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="mahalle" :value="old('mahalle')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="konum_url" class="block mt-1 w-full text-gray-900 dark:text-white" type="url" name="konum_url" :value="old('konum_url')" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="fatura_tipi" name="fatura_tipi" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                <option value="">Seçiniz</option>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="fatura_durumu" name="fatura_durumu" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                <option value="">Seçiniz</option>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="tutar" class="block mt-1 w-full text-gray-900 dark:text-white" type="number" step="0.01" name="tutar" :value="old('tutar')" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="odeme_durumu" name="odeme_durumu" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                <option value="">Seçiniz</option>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="sozlesme_onay_durumu" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="sozlesme_onay_durumu" :value="old('sozlesme_onay_durumu')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="igu" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="igu" :value="old('igu')" />
                            <x-input-error :messages="$errors->get('igu')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="ih" :value="__('İH')" class="text-gray-900 dark:text-white" />
                            <x-text-input id="ih" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="ih" :value="old('ih')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="firma_ziyareti" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="firma_ziyareti" :value="old('firma_ziyareti')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="defter" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="defter" :value="old('defter')" />
                            <x-input-error :messages="$errors->get('defter')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="ra" :value="__('RA')" class="text-gray-900 dark:text-white" />
                            <x-text-input id="ra" class="block mt-1 w-full text-gray-900 dark:text-white" type="text" name="ra" :value="old('ra')" />
